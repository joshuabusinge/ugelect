...
d3.csv("map/presidential_results.csv", function (data) {
	...
	d3.json('map/ug_districts3.geojson', function (error, json) {
...
function generateColor(value)
{
	...
	.range(["yellow", "green", "white", "brown", "grey", "cream", "red", "brown", "slateblue", "blue", "orange"]);
